...
<head>
    ...
    <style>
        ...
        .code { font-size: 2rem; font-weight: bold; color: #2563eb; background: #e0e7ef; border-radius: 8px; padding: 12px; text-align: center; letter-spacing: 0.2em; margin-bottom: 16px; }
