<div class="w-full h-auto flex flex-col justify-around items-center px-4 opacity-0 transform translate-y-10 transition-all duration-1000 ease-out" id="ondeAtendo">
  ...
  <div class="w-full flex flex-col md:flex-row justify-around items-center gap-4 sm:gap-8 md:gap-12 p-4 sm:my-4">

    <!-- Mapa -->
    <div class="w-full md:w-1/2 h-[250px] sm:h-[350px] md:h-[500px]">
      <iframe
    ...
    <!-- Local -->
    <div class="w-full md:w-1/2 h-auto md:h-[500px] flex flex-col items-center justify-center p-4 sm:p-6 md:p-12 bg-white rounded-lg shadow-lg">
      <div class="mb-4 sm:mb-6">
        <img src="/assets/img/logo-brilho.svg" alt="Logo Salão Brilho" class="w-32 sm:w-40 h-auto">
      </div>

      <div class="text-center text-base sm:text-lg md:text-xl font-semibold text-gray-800">
        <div class="mb-4">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
          ...
          <!-- WhatsApp -->
          <a href="https://wa.me/5547991626283?text=Ol%C3%A1%20Fabiana%20estou%20vendo%20seu%20site%20e%20quero%20mais%20informa%C3%A7%C3%B5es!" target="_blank" class="flex items-center gap-2 text-green-600 hover:text-green-800">
