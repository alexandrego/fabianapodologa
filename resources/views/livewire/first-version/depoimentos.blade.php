<div class="w-full h-[900px] bg-[#D9D9D9] flex flex-col justify-around items-center rounded-b-[10px] relative p-4">
    <div id="depoimentos" class="w-full h-auto md:h-[100px] flex justify-center items-center font-iria-sans font-normal text-2xl md:text-[32px] text-black mt-2 md:mt-[8px] mb-6 md:mb-[12px] text-center">
        Depoimentos
    </div>

    <div class="w-full overflow-x-scroll md:overflow-visible scroll-smooth snap-x scrollbar-none">
        <div class="flex space-x-4 md:space-x-0 pl-[5vw]">
            <!-- Depoimento 1 -->
            <div class="w-[85vw] md:w-1/3 h-[650px] flex flex-col items-center justify-around shrink-0 snap-center">
                <div class="w-[80%] flex justify-center">
                    <img class="w-full h-auto" src="/assets/img/depoimento-1.svg" alt="Podologia Geriátrica">
                </div>
            ...
            <div class="w-[85vw] md:w-1/3 h-[650px] flex flex-col items-center justify-around shrink-0 snap-center">
                <div class="w-[80%] flex justify-center">
                    <img class="w-full h-auto" src="/assets/img/depoimento-2.svg" alt="Podologia Geriátrica">
                </div>
                <div class="w-[80%] text-justify">
            ...
            <div class="w-[85vw] md:w-1/3 h-[650px] flex flex-col items-center justify-around shrink-0 snap-center">
                <div class="w-[80%] flex justify-center">
                    <img class="w-full h-auto" src="/assets/img/depoimento-3.svg" alt="Podologia Geriátrica">
                </div>
                <div class="w-[80%] text-justify">
